...
export async function before(m) {
	...
	if (chat && chat.updateAnime) {
		...
		setInterval(async () => {
			...
			if (isMovie && (!('durasi' in detailAnime) || detailAnime.durasidetailAnime.durasi == '???')) return conn.reply(m.chat, 'Bot tidak dapat mengirim file video karena terlalu besar...', quoted)
...
export function parseResult(json, options) {
